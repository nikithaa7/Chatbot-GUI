...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        bottom_label.place(relwidth=1, rely=0.825, relheight=0.075)

        self.msg_entry = Entry(bottom_label, bg="#2C3E50", fg=TEXT_COLOR, font=FONT)
        self.msg_entry.place(relwidth=0.74, relheight=0.9, relx=0.011, rely=0.05)
        ...
        send_button.place(relx=0.77, rely=0.05, relheight=0.9, relwidth=0.22)
